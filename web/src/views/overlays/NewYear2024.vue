    ...
    export default Vue.extend({
        ...
        methods: {
            reloadCountdown() {
                ...
                // if days is 0 dont use it in the countdown
                if (days === 0) {
                    this.countdown = `${hours.toString().padStart(2, "0")}h 
                        ${minutes.toString().padStart(2, "0")}m
                        ${seconds.toString().padStart(2, "0")}s`;
                } else {
                    this.countdown = `${days.toString().padStart(2, "0")}d 
 ...
 */
    ...
    */ radial-gradient(
            ...
            /* top right */ radial-gradient(circle, var(--color1) var(--particleSize), #0000 0) 22%
                14%,
